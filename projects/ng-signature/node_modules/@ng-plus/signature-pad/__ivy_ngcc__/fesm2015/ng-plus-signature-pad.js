...
function SignaturePadComponent_button_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function SignaturePadComponent_button_4_Template_button_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r4); const ctx_r3 = ɵngcc0.ɵɵnextContext(); return ɵngcc0.ɵɵresetView(ctx_r3.emitPointsAndBlob()); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function SignaturePadComponent_button_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵelementStart(0, "button", 5);
    ɵngcc0.ɵɵlistener("click", function SignaturePadComponent_button_5_Template_button_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r6); const ctx_r5 = ɵngcc0.ɵɵnextContext(); return ɵngcc0.ɵɵresetView(ctx_r5.clearPad()); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
SignaturePadComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: SignaturePadComponent, selectors: [["ng-signature-pad"]], viewQuery: function SignaturePadComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, dependencies: [ɵngcc1.NgIf], styles: [".signature-pad[_ngcontent-%COMP%]   canvas[_ngcontent-%COMP%]{background:#f2f2f2}.signature-pad[_ngcontent-%COMP%]   .btn[_ngcontent-%COMP%]{margin-right:.25em}"] });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SignaturePadComponent, [{
        type: Component,
        args: [{ selector: 'ng-signature-pad', template: `<div class="signature-pad">
    <canvas
        [width]="width"
        [height]="height"
        #canvas></canvas>
...
SignaturePadModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [CommonModule] });
